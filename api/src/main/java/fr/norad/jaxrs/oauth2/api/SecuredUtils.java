...
import static fr.norad.core.lang.reflect.MetaAnnotationUtils.findAnnotationWithMetaAnnotation;
...
public class SecuredUtils {
    ...
    public static SecuredInfo findSecuredInfo(Method method) {
        Annotation annotation = findAnnotationWithMetaAnnotation(method, Secured.class);
        if (annotation != null) {
